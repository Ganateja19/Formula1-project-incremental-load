...
# DBTITLE 1,Build Nationality Region Reference
# MAGIC %md
...
nationality_region_map_rows = [
    ...
    Row(nationality="Chile",            region="South America"),
...
# DBTITLE 1,Display Reference Table
